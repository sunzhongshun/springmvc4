...
import com.shunshun.springmvc4.day01.domain.User;
...
public class SpringMVCTest {
    ...
    public void testServletAPI(HttpServletRequest request, HttpServletResponse response, Writer out) throws IOException {
        ...
        out.write("hello springmvc");//转到哪个页面，内容就在哪个页面显示
//		return SUCCESS;
    }
    ...
    public String testModelAttribute(@ModelAttribute("user") User user){//用了这个注解，若类中注解SessionAttribute,
        System.out.println("修改: " + user);//它会去session中有没有user，没有就会报错
        return SUCCESS;//解决就是加上下面这段代码
    }
